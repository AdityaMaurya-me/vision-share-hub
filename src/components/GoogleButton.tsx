...
const GoogleButton = ({ label = "Continue with Google" }: { label?: string }) => {
  ...
  return (
    <Button
      ...
      onClick={handle}
      disabled={loading}
      className="w-full gap-2 border-border bg-secondary/40 hover:bg-secondary"
    >
      <svg viewBox="0 0 24 24" className="h-4 w-4" aria-hidden="true">
        ...
        <path d="M5.84 14.12A6.96 6.96 0 0 1 5.47 12c0-.74.13-1.46.36-2.12V7.04H2.18A11 11 0 0 0 1 12c0 1.77.42 3.45 1.18 4.96l3.66-2.84z" fill="#FBBC05"/>
